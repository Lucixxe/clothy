...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '13dac890-67c6-40f2-83b1-f3f75bbff0a1' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('57b953d8-f78b-43f7-b104-25433408278f');
      cy.get(`[data-cy="name"]`).should('have.value', '57b953d8-f78b-43f7-b104-25433408278f');
