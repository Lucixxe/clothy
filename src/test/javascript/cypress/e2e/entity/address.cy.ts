...
describe('Address e2e test', () => {
  ...
  const addressSample = { line1: 'comme', city: 'Metz', country: 'Barbade' };
  ...
  describe('new Address page', () => {
    ...
    it('should create an instance of Address', () => {
      cy.get(`[data-cy="line1"]`).type('pencher distribuer à seule fin de');
      cy.get(`[data-cy="line1"]`).should('have.value', 'pencher distribuer à seule fin de');

      cy.get(`[data-cy="city"]`).type("Villeneuve-d'Ascq");
      cy.get(`[data-cy="city"]`).should('have.value', "Villeneuve-d'Ascq");

      cy.get(`[data-cy="country"]`).type('Norvège');
      cy.get(`[data-cy="country"]`).should('have.value', 'Norvège');
