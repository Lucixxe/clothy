...
describe('CartItem e2e test', () => {
  ...
  const cartItemSample = { quantity: 4971, unitPrice: 8110.84, lineTotal: 31824.07 };
  ...
  describe('new CartItem page', () => {
    ...
    it('should create an instance of CartItem', () => {
      cy.get(`[data-cy="quantity"]`).type('6492');
      cy.get(`[data-cy="quantity"]`).should('have.value', '6492');

      cy.get(`[data-cy="unitPrice"]`).type('20776.49');
      cy.get(`[data-cy="unitPrice"]`).should('have.value', '20776.49');

      cy.get(`[data-cy="lineTotal"]`).type('7395.95');
      cy.get(`[data-cy="lineTotal"]`).should('have.value', '7395.95');
