...
describe('Cart e2e test', () => {
  ...
  const cartSample = { cartKey: '63b62489-d522-4cd2-91f7-652398a556c6', createdAt: '2025-09-08T04:26:10.784Z', isCheckedOut: false };
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: {
        ...
        firstName: 'Denise',
        lastName: 'Bertrand',
        createdAt: '2025-09-08T03:44:55.356Z',
  ...
  describe('new Cart page', () => {
    ...
    it('should create an instance of Cart', () => {
      ...
      cy.get(`[data-cy="createdAt"]`).type('2025-09-08T04:19');
      cy.get(`[data-cy="createdAt"]`).blur();
      cy.get(`[data-cy="createdAt"]`).should('have.value', '2025-09-08T04:19');
