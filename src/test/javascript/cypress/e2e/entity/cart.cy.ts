...
describe('Cart e2e test', () => {
  ...
  const cartSample = { cartKey: 'c1072f78-3c82-4735-9327-578a8fef03b7', createdAt: '2025-09-07T17:38:44.617Z', isCheckedOut: true };
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      url: '/api/customers',
      body: {
        email: 'Samuel23@gmail.com',
        firstName: 'Arcade',
        name: 'loin magenta',
        createdAt: '2025-09-07T11:04:00.313Z',
        passwordHash: 'aïe à raison de agréable',
        address: 'avant',
      },
    }).then(({ body }) => {
      customer = body;
  ...
  describe('new Cart page', () => {
    ...
    it('should create an instance of Cart', () => {
      ...
      cy.get(`[data-cy="createdAt"]`).type('2025-09-07T10:47');
      cy.get(`[data-cy="createdAt"]`).blur();
      cy.get(`[data-cy="createdAt"]`).should('have.value', '2025-09-07T10:47');
