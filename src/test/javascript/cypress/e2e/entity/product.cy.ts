...
describe('Product e2e test', () => {
  ...
  const productSample = { name: 'proche de prout personnel professionnel', sku: 'police police interroger', price: 8002.33 };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="name"]`).type('miam en bas de');
      cy.get(`[data-cy="name"]`).should('have.value', 'miam en bas de');

      cy.get(`[data-cy="sku"]`).type('pourvu que turquoise');
      cy.get(`[data-cy="sku"]`).should('have.value', 'pourvu que turquoise');

      cy.get(`[data-cy="price"]`).type('30510.41');
      cy.get(`[data-cy="price"]`).should('have.value', '30510.41');
