...
describe('Product e2e test', () => {
  ...
  const productSample = { name: 'parce que sage proche de', sku: 5190, price: 11754.47 };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      ...
      cy.get(`[data-cy="sku"]`).type('14250');
      cy.get(`[data-cy="sku"]`).should('have.value', '14250');

      cy.get(`[data-cy="price"]`).type('16109.17');
      cy.get(`[data-cy="price"]`).should('have.value', '16109.17');
