...
describe('Category e2e test', () => {
  ...
  const categorySample = { name: 'aussitôt que', slug: 'dring', isActive: true };
  ...
  describe('new Category page', () => {
    ...
    it('should create an instance of Category', () => {
      cy.get(`[data-cy="name"]`).type('meuh cadre');
      cy.get(`[data-cy="name"]`).should('have.value', 'meuh cadre');

      cy.get(`[data-cy="slug"]`).type('habile oups dans la mesure où');
      cy.get(`[data-cy="slug"]`).should('have.value', 'habile oups dans la mesure où');
