...
describe('CustomerOrder e2e test', () => {
  ...
  const customerOrderSample = { orderNumber: 'équipe', createdAt: '2025-09-08T09:28:18.874Z', total: 12959.95 };
  ...
  describe('new CustomerOrder page', () => {
    ...
    it('should create an instance of CustomerOrder', () => {
      ...
      cy.get(`[data-cy="createdAt"]`).type('2025-09-07T10:31');
      cy.get(`[data-cy="createdAt"]`).blur();
      cy.get(`[data-cy="createdAt"]`).should('have.value', '2025-09-07T10:31');
