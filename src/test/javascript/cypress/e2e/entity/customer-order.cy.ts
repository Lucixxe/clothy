...
describe('CustomerOrder e2e test', () => {
  ...
  const customerOrderSample = { orderNumber: 'décider pacifique bon', createdAt: '2025-09-03T08:27:50.811Z', total: 27955.39 };
  ...
  describe('new CustomerOrder page', () => {
    ...
    it('should create an instance of CustomerOrder', () => {
      ...
      cy.get(`[data-cy="createdAt"]`).type('2025-09-02T17:06');
      cy.get(`[data-cy="createdAt"]`).blur();
      cy.get(`[data-cy="createdAt"]`).should('have.value', '2025-09-02T17:06');
