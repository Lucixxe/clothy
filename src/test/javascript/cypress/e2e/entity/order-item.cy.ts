...
describe('OrderItem e2e test', () => {
  ...
  const orderItemSample = { quantity: 22693, unitPrice: 32448.32, lineTotal: 4632.02 };
  ...
  describe('new OrderItem page', () => {
    ...
    it('should create an instance of OrderItem', () => {
      cy.get(`[data-cy="quantity"]`).type('26627');
      cy.get(`[data-cy="quantity"]`).should('have.value', '26627');

      cy.get(`[data-cy="unitPrice"]`).type('9581.38');
      cy.get(`[data-cy="unitPrice"]`).should('have.value', '9581.38');

      cy.get(`[data-cy="lineTotal"]`).type('15258.71');
      cy.get(`[data-cy="lineTotal"]`).should('have.value', '15258.71');
