...
import static com.clothy.myapp.domain.OrderItemAsserts.*;
...
class OrderItemResourceIT {
    ...
    public static OrderItem createEntity() {
        return new OrderItem().quantity(DEFAULT_QUANTITY).unitPrice(DEFAULT_UNIT_PRICE).lineTotal(DEFAULT_LINE_TOTAL);
    }
    ...
    public static OrderItem createUpdatedEntity() {
        return new OrderItem().quantity(UPDATED_QUANTITY).unitPrice(UPDATED_UNIT_PRICE).lineTotal(UPDATED_LINE_TOTAL);
    }
    ...
    void putExistingOrderItem() throws Exception {
        ...
        updatedOrderItem.quantity(UPDATED_QUANTITY).unitPrice(UPDATED_UNIT_PRICE).lineTotal(UPDATED_LINE_TOTAL);
    ...
    void partialUpdateOrderItemWithPatch() throws Exception {
        ...
        partialUpdatedOrderItem.quantity(UPDATED_QUANTITY).unitPrice(UPDATED_UNIT_PRICE).lineTotal(UPDATED_LINE_TOTAL);
