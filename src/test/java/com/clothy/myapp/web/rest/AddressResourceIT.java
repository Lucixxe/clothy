...
import static com.clothy.myapp.domain.AddressAsserts.*;
...
class AddressResourceIT {
    ...
    public static Address createEntity() {
        return new Address().line1(DEFAULT_LINE_1).city(DEFAULT_CITY).country(DEFAULT_COUNTRY);
    }
    ...
    public static Address createUpdatedEntity() {
        return new Address().line1(UPDATED_LINE_1).city(UPDATED_CITY).country(UPDATED_COUNTRY);
    }
    ...
    void putExistingAddress() throws Exception {
        ...
        updatedAddress.line1(UPDATED_LINE_1).city(UPDATED_CITY).country(UPDATED_COUNTRY);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.line1(UPDATED_LINE_1);
    ...
    void fullUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.line1(UPDATED_LINE_1).city(UPDATED_CITY).country(UPDATED_COUNTRY);
