...
class CartItemResourceIT {
    ...
    public static CartItem createEntity() {
        return new CartItem().quantity(DEFAULT_QUANTITY).unitPrice(DEFAULT_UNIT_PRICE).lineTotal(DEFAULT_LINE_TOTAL);
    }
    ...
    public static CartItem createUpdatedEntity() {
        return new CartItem().quantity(UPDATED_QUANTITY).unitPrice(UPDATED_UNIT_PRICE).lineTotal(UPDATED_LINE_TOTAL);
    }
    ...
    void putExistingCartItem() throws Exception {
        ...
        updatedCartItem.quantity(UPDATED_QUANTITY).unitPrice(UPDATED_UNIT_PRICE).lineTotal(UPDATED_LINE_TOTAL);
    ...
    void partialUpdateCartItemWithPatch() throws Exception {
        ...
        partialUpdatedCartItem.quantity(UPDATED_QUANTITY).lineTotal(UPDATED_LINE_TOTAL);
    ...
    void fullUpdateCartItemWithPatch() throws Exception {
        ...
        partialUpdatedCartItem.quantity(UPDATED_QUANTITY).unitPrice(UPDATED_UNIT_PRICE).lineTotal(UPDATED_LINE_TOTAL);
