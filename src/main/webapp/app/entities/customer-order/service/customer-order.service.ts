...
type RestOf<T extends ICustomerOrder | NewCustomerOrder> = Omit<T, 'createdAt'> & {
...
export class CustomerOrderService {
  ...
  protected convertDateFromClient<T extends ICustomerOrder | NewCustomerOrder | PartialUpdateCustomerOrder>(customerOrder: T): RestOf<T> {
    return {
      ...customerOrder,
      createdAt: customerOrder.createdAt?.toJSON() ?? null,
    };
  }
  ...
  protected convertDateFromServer(restCustomerOrder: RestCustomerOrder): ICustomerOrder {
    return {
      ...restCustomerOrder,
      createdAt: restCustomerOrder.createdAt ? dayjs(restCustomerOrder.createdAt) : undefined,
    };
  }
