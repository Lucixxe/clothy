...
export class CartItemService {
  ...
  addToCart(cartId: number, productId: number, quantity: number): Observable<ICartItem> {
    return this.http.post<ICartItem>(`${this.resourceUrl}/creation-cartItem`, { cartId, productId, quantity });
  }
